// nodes/drawing/DrawRoundedRect.cpp
#include "DrawRoundedRect.h"
#include "Utility.h"
#include <QPainter>

void DrawRoundedRect::defineNode()
{
	...
	addParam("corner_radius", "圆角半径", ParamType::IntSlider, 10, { {"min", 0}, {"max", 200} });
...
void DrawRoundedRect::process()
{
	...
	painter.drawRoundedRect(param("x").toInt(), param("y").toInt(),
