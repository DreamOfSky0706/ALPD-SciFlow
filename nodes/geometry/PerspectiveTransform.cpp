// nodes/geometry/PerspectiveTransform.cpp
#include "PerspectiveTransform.h"
#include "Utility.h"
#include <opencv2/imgproc.hpp>

void PerspectiveTransform::defineNode()
{
	...
	addParam("src_x2", "源点3 X", ParamType::Double, 100.0, { {"min", -99999}, {"max", 99999} });
	addParam("src_y2", "源点3 Y", ParamType::Double, 100.0, { {"min", -99999}, {"max", 99999} });
	addParam("src_x3", "源点4 X", ParamType::Double, 0.0, { {"min", -99999}, {"max", 99999} });
	addParam("src_y3", "源点4 Y", ParamType::Double, 100.0, { {"min", -99999}, {"max", 99999} });
	...
	addParam("dst_x1", "目标点2 X", ParamType::Double, 90.0, { {"min", -99999}, {"max", 99999} });
	addParam("dst_y1", "目标点2 Y", ParamType::Double, 15.0, { {"min", -99999}, {"max", 99999} });
	addParam("dst_x2", "目标点3 X", ParamType::Double, 95.0, { {"min", -99999}, {"max", 99999} });
	addParam("dst_y2", "目标点3 Y", ParamType::Double, 95.0, { {"min", -99999}, {"max", 99999} });
	addParam("dst_x3", "目标点4 X", ParamType::Double, 5.0, { {"min", -99999}, {"max", 99999} });
	addParam("dst_y3", "目标点4 Y", ParamType::Double, 90.0, { {"min", -99999}, {"max", 99999} });
...
void PerspectiveTransform::process()
{
	...
	srcPts[3] = cv::Point2f(param("src_x3").toFloat(), param("src_y3").toFloat());
	...
	dstPts[3] = cv::Point2f(param("dst_x3").toFloat(), param("dst_y3").toFloat());

	cv::Mat warpMat = cv::getPerspectiveTransform(srcPts, dstPts);
	...
	cv::Mat dst;
	cv::warpPerspective(src, dst, warpMat, cv::Size(outW, outH),
